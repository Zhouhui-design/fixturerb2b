...
export const translations: Record<Language, Translations> = {
  ...
  zh: {
    ...
    aboutPage: {
      heroBadge: '⚡ 注册的一人公司（OPC）',
      heroTitle: '从图纸到店铺<br />– 我来实现。',
      heroSubtitle: '您的商业家具。一人负责，全程掌控。',
      heroDescription: '定制店铺室内设计的直接协调。10+经过审核的工厂，一位负责任的创始人。没有层级，没有借口。',
      startProject: '开始项目 →',
      viewProcess: '查看流程',
      brandStoryTitle: '品牌故事',
      brandStoryP1: '<strong>我在商业家具行业深耕多年——不仅仅是销售，还包括为零售店、展厅和品牌店设计、成本核算、采购和质量控制真实项目。</strong>',
      brandStoryP2: '我一次又一次看到同样的问题：一家店铺需要50到100多种不同的定制物品——柜台、展示架、中岛台、灯箱、试衣间镜子、墙面货架……每件都有自己的设计、数量（有时只有一件）和材料要求。大多数供应商要么拒绝这种复杂订单，要么交给初级协调员，导致细节遗漏和时间延误。',
      brandStoryP3: '所以我创立了<strong>杭州购汇国际贸易有限公司</strong>——一家<strong>合法注册的一人公司（OPC）</strong>。没有董事会。没有推销配额的销售团队。只有我，一本装满供应商联系方式的笔记本，以及一个简单的信念：<em>复杂的店铺项目值得一个了解每个细节的负责任的人。</em>',
      brandStoryP4: '我亲自审核您的店铺设计并创建成本明细；将每件物品匹配到我10+可靠商业家具供应商网络中最合适的工厂；控制质量、尺寸、表面处理——因为我曾经自己做工艺深化；协调运输和交付，这样您就不必与五个不同的人交谈。',
      brandStoryP5: '我没有巨大的工厂。但我有更好的东西：直接接触10家专业工厂，以及让您的项目正确的个人动力。',
      brandStoryP6: '如果您是一位厌倦了被推来推去的店主或品牌经理，试试我。一封邮件，一个人，一个解决方案。',
      companyTitle: '公司与透明度',
      companyName: '杭州购汇国际贸易有限公司',
      registeredOPC: '<strong>注册的一人公司（OPC）</strong>——完全符合中国法律。',
      founder: '<strong>创始人：</strong>勾辉',
      paidUpCapital: '<strong>实缴资本：</strong>人民币10万元',
      specialization: '<strong>专业化：</strong>为零售店、品牌店和展示空间提供定制商业家具项目协调。',
      businessLicenseTitle: '公开营业执照',
      registrationNo: '<strong>注册号：</strong>',
      verification: '<strong>验证：</strong>您可以在中国国家企业信用信息公示系统（<a href="http://www.gsxt.gov.cn" target="_blank" rel="noopener noreferrer">www.gsxt.gov.cn</a>）使用我们的注册号检查我们的状态。',
      verificationLink: 'www.gsxt.gov.cn',
      transparent: '✅ 完全透明——所见即所得。',
      whatWeDoTitle: '我们的不同之处',
      whatWeDo1: '单一联系点——创始人',
      whatWeDo2: '10+经过审核的家具工厂',
      whatWeDo3: '端到端：设计审核 → 成本核算 → 采购 → 质量控制 → 运输',
      whatWeDo4: '没有隐藏的团队照片，没有虚假的"我们"声明',
      ourPromise: '我们的承诺：50件或500件定制产品，我 personally 确保每一件都符合您的规格。',
      howWeWorkTitle: '我们的工作方式',
      howWeWorkSubtitle: '从您的店铺计划到完成的安装',
      step1Title: '📐 分享您的店铺设计和需求',
      step1Desc: '发送平面图、参考照片或所需物品的简单列表（柜台、货架、灯箱、镜子等）。我会帮助澄清。',
      step2Title: '💰 详细的成本明细',
      step2Desc: '基于我的行业经验（设计、成本核算、采购），我分解每件物品：材料选项、估计单价、总成本和交货时间。',
      step3Title: '🏭 将每件物品匹配到最佳工厂',
      step3Desc: '我与10+专业供应商合作。我将每件产品分配给能为您提供最佳质量、价格和交货时间平衡的工厂。',
      step4Title: '🔍 样品和生产跟进',
      step4Desc: '为关键物品安排样品。在批量生产期间，我 personally 检查尺寸、表面处理和装配细节。',
      step5Title: '✅ 运输前的质量控制',
      step5Desc: '在任何物品离开工厂之前，我检查代表性批次。如果某物不符合规格，我会停止它并进行纠正。',
      step6Title: '🚢 运输协调和售后',
      step6Desc: '我安排海运/空运/快递运输。您得到一个跟踪摘要，而不是十个不同的运单。交付后，如果出现任何隐藏缺陷，给我发邮件——48小时内解决。',
      responsibility: '一人负责，全程责任。没有交接，没有借口。',
      founderNoteTitle: '勾辉（创始人）的话',
      founderNoteP1: '"当您给我发邮件时，您不是在聊天机器人或支持工单系统交谈。您在与设计、成本核算和协调整个项目的人交谈。我在工作日24小时内回复——不是因为我必须这样做，而是因为这就是我希望被对待的方式。',
      founderNoteP2: '我不躲在不存在\'团队\'后面。我的公司规模小是有意为之，所以我可以快速行动，保持价格公平，并对每个订单承担全部责任。如果出现问题，我 personally 修复它。"',
      founderName: '— 勾辉',
      founderTitle: '创始人，杭州购汇国际贸易有限公司',
      ctaTitle: '准备好装备您的店铺了吗？',
      ctaDescription: '发送您的设计或需求清单——我将在24小时内回复清晰的行动计划。',
      getInTouch: '联系我们 →',
      contactNote: '📧 通过表单联系我们 | 可根据要求提供微信/WhatsApp'
    }
  },
